...
#
# ************************************************************************************************************************************************
# Name    : cell_availability.py
# Purpose : Runs a CM CLI command to list the Admin and Operational states of each node in the network and writes the response to a specific file.
# Version : 1.3
# ************************************************************************************************************************************************
#
import sys
...
# CM CLI Commands
CELL_AVAILABILITY_COMMAND = "cmedit get * EUtranCellFDD.(administrativeState, operationalState)"

# Script configuration
DIRECTORY_TO_STORE_OUTPUT_FILE = "/home/shared/nbicm1/TEST_MOUNT/"
OUTPUT_FILE_NAME = "cell_availability.txt"

LOG_NAME = "cell_availability_debug.log"
logger = None
...
def main():
    ...
    try:
        ...
        response_lines = execute_enm_cli_command(terminal, CELL_AVAILABILITY_COMMAND)
